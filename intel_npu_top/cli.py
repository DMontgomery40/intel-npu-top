#!/usr/bin/env python3
"""Command-line interface for nputop."""
...
BAR_WIDTH = 5  # width of the ASCII bar
HISTORY_LENGTH = 10

def read_runtime():
    """Read the NPU runtime from the device."""
    try:
...
def main():
    ...
    try:
        while True:
            ...
            if current_runtime == 0.0:  # Possible error reading device
                time.sleep(1)
                continue
